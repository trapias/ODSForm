...
#Region "ODSFormItem Methods"
        ...
        Public Overrides Function AddODSFormItem(ByVal moduleID As Integer, ByVal portalID As Integer, ByVal formType As Integer, ByVal formValue As String, ByVal formSelectedValue As String, ByVal formLabel As String, ByVal sortValue As Integer, ByVal [optional] As Boolean, ByVal width As Integer, ByVal height As Integer, ByVal CSSClass As String, ByVal CustomRegex As String, ByVal FormItemTitle As String, ByVal FormLabelClass As String, ByVal CultureCode As String, ByVal AllowValueOverride As Boolean, ByVal CustomData As String, ByVal WebhookFieldName As String) As Integer
            Return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner & ObjectQualifier & "ODSFormItemAdd", moduleID, portalID, formType, GetNull(formValue), GetNull(formSelectedValue), GetNull(formLabel), sortValue, [optional], width, height, CSSClass, CustomRegex, FormItemTitle, FormLabelClass, CultureCode, AllowValueOverride, CustomData, WebhookFieldName), Integer)
        End Function
        ...
        Public Overrides Sub UpdateODSFormItem(ByVal formItemID As Integer, ByVal moduleID As Integer, ByVal portalID As Integer, ByVal formType As Integer, ByVal formValue As String, ByVal formSelectedValue As String, ByVal formLabel As String, ByVal [optional] As Boolean, ByVal width As Integer, ByVal height As Integer, ByVal CSSClass As String, ByVal CustomRegex As String, ByVal FormItemTitle As String, ByVal FormLabelClass As String, ByVal CultureCode As String, ByVal AllowValueOverride As Boolean, ByVal CustomData As String, ByVal WebhookFieldName As String)
            ...
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner & ObjectQualifier & "ODSFormItemUpdate", formItemID, moduleID, portalID, formType, GetNull(formValue), GetNull(formSelectedValue), GetNull(formLabel), [optional], width, height, CSSClass, CustomRegex, FormItemTitle, FormLabelClass, CultureCode, AllowValueOverride, CustomData, WebhookFieldName)
        End Sub
